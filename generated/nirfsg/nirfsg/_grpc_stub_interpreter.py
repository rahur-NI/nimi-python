...
class GrpcStubInterpreter(object):
    ...
    def create_deembedding_sparameter_table_array(self, port, table_name, frequencies, sparameter_table, sparameter_table_size, number_of_ports, sparameter_orientation):  # noqa: N802
        ...
        self._invoke(
            ...
            grpc_types.CreateDeembeddingSparameterTableArrayRequest(vi=self._vi, port=port, table_name=table_name, frequencies=frequencies, sparameter_table=sparameter_table_list, sparameter_table_size=sparameter_table_size, number_of_ports=number_of_ports, sparameter_orientation_raw=sparameter_orientation.value),
        )
