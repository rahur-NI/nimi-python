...
class GrpcStubInterpreter(object):
    ...
    def clear_arb_waveform(self, waveform_name):  # noqa: N802
        self._invoke(
            ...
            grpc_types.ClearArbWaveformRequest(vi=self._vi, waveform_name=waveform_name),
        )
    ...
    def create_deembedding_sparameter_table_array(self, port, table_name, frequencies, sparameter_table, sparameter_table_size, number_of_ports, sparameter_orientation):  # noqa: N802
        self._invoke(
            ...
            grpc_types.CreateDeembeddingSparameterTableArrayRequest(vi=self._vi, port=port, table_name=table_name, frequencies=frequencies, sparameter_table=sparameter_table, sparameter_table_size=sparameter_table_size, number_of_ports=number_of_ports, sparameter_orientation_raw=sparameter_orientation.value),
        )
    ...
    def select_arb_waveform(self, waveform_name):  # noqa: N802
        self._invoke(
            ...
            grpc_types.SelectArbWaveformRequest(vi=self._vi, waveform_name=waveform_name),
        )
    ...
    def set_attribute_vi_int64(self, channel_name, attribute, value):  # noqa: N802
        self._invoke(
            ...
            grpc_types.SetAttributeViInt64Request(vi=self._vi, channel_name=channel_name, attribute_id=attribute, value=value),
        )
    ...
    def write_arb_waveform_complex_f32(self, waveform_name, waveform_data_array, more_data_pending):  # noqa: N802
        self._invoke(
            ...
            grpc_types.WriteArbWaveformComplexF32Request(vi=self._vi, waveform_name=waveform_name, wfm_data=waveform_data_array, more_data_pending=more_data_pending),
        )
    ...
    def write_arb_waveform_complex_f64(self, waveform_name, waveform_data_array, more_data_pending):  # noqa: N802
        self._invoke(
            ...
            grpc_types.WriteArbWaveformComplexF64Request(vi=self._vi, waveform_name=waveform_name, wfm_data=waveform_data_array, more_data_pending=more_data_pending),
        )
    ...
    def write_arb_waveform_complex_i16(self, waveform_name, waveform_data_array):  # noqa: N802
        self._invoke(
            ...
            grpc_types.WriteArbWaveformComplexI16Request(vi=self._vi, waveform_name=waveform_name, wfm_data=waveform_data_array),
        )
    ...
    def self_test(self):  # noqa: N802
        response = self._invoke(
            self._client.self_test,
            grpc_types.self_testRequest(vi=self._vi),
        )
